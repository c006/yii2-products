...
/* @var $modelc006\products\models\ProductTag */
...
<div class="product-tag-form">
    ...
    <?
    $model_link = \c006\products\models\ProductTag::find()->all();
    $model_link = ArrayHelper::map($model_link, 'id', 'value');
    echo $form->field($model, 'tag_id')->dropDownList($model_link)->label('Product Tag') ?>
