...
class ProductValueTextAreaController extends Controller
{
    ...
    /**
     * Lists all ProductValueTextArea models.
     * @return mixed
     */
    ...
    /**
     * Displays a single ProductValueTextArea model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new ProductValueTextArea model.
    ...
    /**
     * Updates an existing ProductValueTextArea model.
    ...
    /**
     * Deletes an existing ProductValueTextArea model.
    ...
    /**
     * Finds the ProductValueTextArea model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ProductValueTextArea the loaded model
